...
export default class DataKaryawanLocal {
    constructor(selector) {
        ...
        this.options = {
            ...
            ajax: {
                url: '/master/karyawan/lookup-by-name-local',
                dataType: "json",
                delay: 1250,
                type: "GET",
                ...
                processResults: function (dataResp) {
                    ...
                    return {
                        results: $.map(data, function (item) {
                            const {sales_npp, nama_karyawan, email, jabatan, unit_kerja_id, kode_unit, nama_unit} = item
                            return {
                                text: nama_karyawan,
                                id: sales_npp,
                                additional: jabatan + '#' + nama_unit,
                                source: item,
                            }
                        })
                    };
