...
export const chartDataStockCarbon = () => {
    const kategori = []
    const dataActual = []
    const dataProyeksi = []
    let nilaiPrev = 134.23
    let nilaiProyeksiPrev = 134.235
    ...
    Highcharts.chart('chart-stock-carbon', {
        chart: {
            type: 'column',
            style: {
                fontFamily: 'Nunito'
            ...
            formatter: function () {
                return `
                        <div class="flex flex-col">
                            <div class="text-sm">Rerata Stock Karbon</div>
                            <div>
                                <table>
                                    <tr>
